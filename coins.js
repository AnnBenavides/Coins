...
function check_my_coins(){
  ...
  cod=per.options[per.selectedIndex].value;
  var coins = 15;
...
function check_comp(){
  ...
  c = c +  c01.options[c01.selectedIndex].value;
  var c02 = document.getElementById('c02');
  c = c +  c02.options[c02.selectedIndex].value;
  var c03 = document.getElementById('c03');
  c = c +  c03.options[c03.selectedIndex].value;
  var c04 = document.getElementById('c04');
  c = c +  c04.options[c04.selectedIndex].value;
  var c05 = document.getElementById('c05');
  c = c +  c05.options[c05.selectedIndex].value;
  var c06 = document.getElementById('c06');
  c = c +  c06.options[c06.selectedIndex].value;
  var c07 = document.getElementById('c07');
  c = c +  c07.options[c07.selectedIndex].value;
  var c08 = document.getElementById('c08');
  c = c +  c08.options[c08.selectedIndex].value;
  var c09 = document.getElementById('c09');
  c = c +  c09.options[c09.selectedIndex].value;
  var c10 = document.getElementById('c10');
  c = c +  c10.options[c10.selectedIndex].value;
  var c11 = document.getElementById('c11');
  c = c +  c11.options[c11.selectedIndex].value;
  var c12 = document.getElementById('c12');
  c = c +  c12.options[c12.selectedIndex].value;
  var c13 = document.getElementById('c13');
  c = c +  c13.options[c13.selectedIndex].value;
...
function check_dis(){
  ...
  d = d +  d01.options[d01.selectedIndex].value;
  var d02 = document.getElementById('d02');
  d = d +  d02.options[d02.selectedIndex].value;
  var d03 = document.getElementById('d03');
  d = d +  d03.options[d03.selectedIndex].value;
  var d04 = document.getElementById('d04');
  d = d +  d04.options[d04.selectedIndex].value;
  var d05 = document.getElementById('d05');
  d = d +  d05.options[d05.selectedIndex].value;
  var d06 = document.getElementById('d06');
  d = d +  d06.options[d06.selectedIndex].value;
  var d07 = document.getElementById('d07');
  d = d +  d07.options[d07.selectedIndex].value;
  var d08 = document.getElementById('d08');
  d = d +  d08.options[d08.selectedIndex].value;
  var d09 = document.getElementById('d09');
  d = d +  d09.options[d09.selectedIndex].value;
  var d10 = document.getElementById('d10');
  d = d +  d10.options[d10.selectedIndex].value;
  var d11 = document.getElementById('d11');
  d = d +  d11.options[d11.selectedIndex].value;
  var d12 = document.getElementById('d12');
  d = d +  d12.options[d12.selectedIndex].value;
  var d13 = document.getElementById('d13');
  d = d +  d13.options[d13.selectedIndex].value;
  var d14 = document.getElementById('d14');
  d = d +  d14.options[d14.selectedIndex].value;
  var d15 = document.getElementById('d15');
  d = d +  d15.options[d15.selectedIndex].value;
...
function check_model(){
  ...
  m = m +  m01.options[m01.selectedIndex].value;
  var m02 = document.getElementById('m02');
  m = m +  m02.options[m02.selectedIndex].value;
  var m03 = document.getElementById('m03');
  m = m +  m03.options[m03.selectedIndex].value;
  var m04 = document.getElementById('m04');
  m = m +  m04.options[m04.selectedIndex].value;
  var m05 = document.getElementById('m05');
  m = m +  m05.options[m05.selectedIndex].value;
  var m06 = document.getElementById('m06');
  m = m +  m06.options[m06.selectedIndex].value;
  var m07 = document.getElementById('m07');
  m = m +  m07.options[m07.selectedIndex].value;
  var m08 = document.getElementById('m08');
  m = m +  m08.options[m08.selectedIndex].value;
  var m09 = document.getElementById('m09');
  m = m +  m09.options[m09.selectedIndex].value;
  var m10 = document.getElementById('m10');
  m = m +  m10.options[m10.selectedIndex].value;
  var m11 = document.getElementById('m11');
  m = m +  m11.options[m11.selectedIndex].value;
  var m12 = document.getElementById('m12');
  m = m +  m12.options[m12.selectedIndex].value;
  var m13 = document.getElementById('m13');
  m = m +  m13.options[m13.selectedIndex].value;
