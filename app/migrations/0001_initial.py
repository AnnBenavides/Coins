...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Grupo',
            fields=[
                ('nroGrupo', models.IntegerField(serialize=False, primary_key=True)),
                ('usr1', models.ForeignKey(related_name='1+', to='app.Alumno')),
                ('usr2', models.ForeignKey(related_name='2+', to='app.Alumno')),
                ('usr3', models.ForeignKey(related_name='3+', to='app.Alumno')),
                ('usr4', models.ForeignKey(related_name='4+', to='app.Alumno')),
                ('usr5', models.ForeignKey(blank=True, to='app.Alumno', related_name='5+', null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Historial',
        ...
        migrations.AddField(
            model_name='bloque',
            name='grupo',
            field=models.ForeignKey(blank=True, to='app.Grupo', null=True),
        ),
        migrations.AddField(
            model_name='bloque',
            name='profe',
